...
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "𝑾𝑶𝑹𝑳𝑫 𝑴𝑼𝑺𝑰𝑪 💗ˣ.​")

# Your User ID.
OWNER_ID = list(
    map(int, getenv("OWNER_ID", "1491415522").split())
...
# Images
START_IMG_URL = getenv("START_IMG_URL", "https://telegra.ph/file/a6c96cdbd066ca2388d06.jpg")
